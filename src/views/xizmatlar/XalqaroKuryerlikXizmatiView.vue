...
export default {
    data() {
        return {
            ...
            isOpen: false,
            pageTitle: `${this.$t('sub.xalqaroKuryerlikXizmati')} - ${import.meta.env.VITE_EMU_APP_NAME}`,
            pageDescription: this.$t('sub.xalqaroKuryerlikXizmati'),
            pageKeyword: this.$t('sub.xalqaroKuryerlikXizmati').replaceAll(' ', ', '),
            domain: `${window.location.origin}`,
            canonical: `${window.location.origin}/xizmatlar/xalqaro-kuryerlik-xizmatlar`,
            alternateUz: `${window.location.origin}/uz/xizmatlar/xalqaro-kuryerlik-xizmatlar`,
            alternateRu: `${window.location.origin}/ru/xizmatlar/xalqaro-kuryerlik-xizmatlar`,
            alternateEn: `${window.location.origin}/en/xizmatlar/xalqaro-kuryerlik-xizmatlar`,
