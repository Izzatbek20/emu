...
export default {
    data() {
        return {
            ...
            isOpen: false,
            pageTitle: `${this.$t('sub.individual')} - ${import.meta.env.VITE_EMU_APP_NAME}`,
            pageDescription: this.$t('sub.individual'),
            pageKeyword: this.$t('sub.individual').replaceAll(' ', ', '),
            domain: `${window.location.origin}`,
            canonical: `${window.location.origin}/xizmatlar/individual`,
            alternateUz: `${window.location.origin}/uz/xizmatlar/individual`,
            alternateRu: `${window.location.origin}/ru/xizmatlar/individual`,
            alternateEn: `${window.location.origin}/en/xizmatlar/individual`,
