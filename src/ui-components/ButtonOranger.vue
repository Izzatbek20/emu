<template>
    <div class="h-14">
        <button
            class="group hover-button inline-flex px-8 max-md:px-4 h-full items-center justify-center relative bg-orange overflow-hidden rounded-[100px] flex-shrink-0">
